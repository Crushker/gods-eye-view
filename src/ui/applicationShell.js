  ...
  constructor(
    ...
    this._locationNavigation = new LocationNavigation({
      ...
      elements: {
        ...
        _locationFavourites: this._locationFavourites,
        _locationFavouritesToggle: this._locationFavouritesToggle,
        _locationFavouriteAdd: this._locationFavouriteAdd,
        _locationFavouriteForm: this._locationFavouriteForm,
        _locationFavouriteName: this._locationFavouriteName,
        _flightSearchForm: this._flightSearchForm,
        _flightProvider: this._flightProvider,
        _flightSearchInput: this._flightSearchInput,
        _flightSearchStatus: this._flightSearchStatus,
        _flightIncomingTrack: this._flightIncomingTrack,
