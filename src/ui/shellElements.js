...
export function readShellElements(document = globalThis.document) {
  return {
    ...
    _locationFavourites: document.getElementById('location-favourites'),
    _locationFavouritesToggle: document.getElementById('location-favourites-toggle'),
    _locationFavouriteAdd: document.getElementById('location-favourite-add'),
    _locationFavouriteForm: document.getElementById('location-favourite-form'),
    _locationFavouriteName: document.getElementById('location-favourite-name'),
    _flightSearchForm: document.getElementById('flight-search-form'),
    _flightProvider: document.getElementById('flight-provider'),
    _flightSearchInput: document.getElementById('flight-search-input'),
    _flightSearchStatus: document.getElementById('flight-search-status'),
    _flightIncomingTrack: document.getElementById('flight-incoming-track'),
